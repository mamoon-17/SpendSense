...
export const Reports: React.FC = () => {
  ...
  const { data: reportData } = useQuery({
    ...
    queryFn: () => reportsAPI.getSpendingReport(reportPeriod).then(res => res.data),
  });
  ...
  const totalIncome = monthlySpendingData[monthlySpendingData.length - 1].income;
  const totalExpenses = monthlySpendingData[monthlySpendingData.length - 1].expenses;
  const totalSavings = monthlySpendingData[monthlySpendingData.length - 1].savings;
                  ...
                  <div className="h-80 w-full">
                    <ResponsiveContainer width="100%" height="100%">
                      <LineChart data={monthlySpendingData}>
                        ...
                        <Line type="monotone" dataKey="expenses" stroke="hsl(var(--primary))" strokeWidth={3} />
                        <Line type="monotone" dataKey="savings" stroke="hsl(var(--warning))" strokeWidth={3} />
                      </LineChart>
                    </ResponsiveContainer>
                  </div>
                </CardContent>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <Card className="card-financial">
                  <CardHeader>
                    ...
                    <CardDescription>Spending breakdown with trends</CardDescription>
                  </CardHeader>
                  ...
                  <div className="h-64 w-full">
                    <ResponsiveContainer width="100%" height="100%">
                      <BarChart data={savingsGoalsData}>
                        ...
                        <Bar dataKey="current" fill="hsl(var(--success))" radius={[4, 4, 0, 0]} />
                  ...
                  <CardContent className="space-y-4">
                      ...
                      <div className="flex items-start space-x-3">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-foreground mt-1">
                            Your savings rate improved by 3.2% this month. You're on track to meet your emergency fund goal 2 months early!
                          </p>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="p-4 bg-warning/10 rounded-lg border border-warning/20">
                      <div className="flex items-start space-x-3">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-foreground mt-1">
                            Your dining expenses increased 23% this month. Consider meal planning to reduce costs by an estimated $200/month.
                          </p>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="p-4 bg-primary/10 rounded-lg border border-primary/20">
                      <div className="flex items-start space-x-3">
                        ...
                        <div>
                          <h4 className="font-medium text-primary">Smart Recommendation</h4>
                          <p className="text-sm text-foreground mt-1">
                            Based on your income growth, consider increasing your investment contribution by $300/month to maximize long-term wealth building.
                          </p>
                        </div>
                      </div>
                    </div>
                  ...
                  <CardContent>
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                      <div className="p-4 border border-border rounded-lg text-center">
                        ...
                        <p className="text-xs text-muted-foreground">More saved</p>
                      </div>
                      <div className="p-4 border border-border rounded-lg text-center">
                      ...
                      <div className="p-4 border border-border rounded-lg text-center">
                        ...
                        <p className="text-xs text-muted-foreground">Closer to targets</p>
                      </div>
                    </div>
                  </CardContent>
                </Card>
